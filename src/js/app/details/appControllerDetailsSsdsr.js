 ...
 * @author:				    wuwg
 * @description             appControllerDetailsSsdsr.js ,  详情模块下的诉讼当事人
 * @rules                   命名规则  app+controller+moduleName+name
 */
define('appControllerDetailsSsdsr',['config','global'],function(config,global){
    
    return function (app) {
        app.controller('appControllerDetailsSsdsr', function ($scope) {
            $scope.scope={
                name:'诉讼当事人',
                content:'这是诉讼当事人的内容，这是诉讼当事人的内容,这是诉讼当事人的内容',
                // 请求数据的url
                serverUrl:config.url.details.ssdsr,
                // 发送到后台服务器的data数据
                serverData: function () {
                    return  {
